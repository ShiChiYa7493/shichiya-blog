		...
		<div className="relative z-20 w-full max-w-2xl mx-auto px-4">
			...
			>
				...
				<div className="flex flex-col md:flex-row md:items-center md:gap-8">
					...
					<div className="flex flex-col items-center md:items-start md:flex-1">
						...
						<div className="flex items-center gap-4 mb-3">
							<motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ duration: 0.5, delay: 0.6, type: "spring" }}>
								<img
									src="/avatar.jpg"
									alt="优川七夜"
							...
							<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}>
								<h1 className="text-2xl md:text-3xl font-bold text-white" style={{ fontFamily: "'Noto Serif SC', Georgia, serif" }}>
									优川七夜
								</h1>
								<p className="text-blue-100/60 text-xs tracking-widest uppercase">Yuga Shichiya</p>
							</motion.div>
						</div>
                ...
                今乗り越え 未来へと Weigh Anchor!
							...
							<p className="text-blue-100/50 text-xs mt-1">跨越现今，前往未来，起锚吧！</p>
						</motion.div>
					</div>
